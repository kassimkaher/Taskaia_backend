...
const MOCK_CARDS = [
  ...
  { id: 'trello_card_003', title: 'Write unit tests for the recording pipeline', description: 'Action item from voice recording — 2026-04-22.\n\nCover STT upload, Notion summarization, and Trello MCP.', url: 'https://trello.com/c/CDEFGHIJ/3-write-unit-tests', shortUrl: 'https://trello.com/c/CDEFGHIJ', listId: 'list_xyz789', listName: 'To-Do', boardId: 'board_abc123', createdAt: '2026-04-22T09:45:00.000Z', labels: [], members: [] },
